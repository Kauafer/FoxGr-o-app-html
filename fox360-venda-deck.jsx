  ...
  <div data-screen-label={`${String(idx + 1).padStart(2, '0')} slide`} style={{
    ...
    <div style={{
      ...
      <div style={{
        ...
        background: CL.brandGreen,
        display: 'grid', placeItems: 'center',
      }}>
        <svg width="20" height="20" viewBox="0 0 24 24" fill="#fff">
          <path d="M12 22V8M8 14c0-3 1.8-5 4-5M16 14c0-3-1.8-5-4-5M9 10c0-2 1.3-4 3-4M15 10c0-2-1.3-4-3-4"
            stroke="#fff" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
        </svg>
      </div>
      <div style={{ font: '800 14px Inter', letterSpacing: '0.04em', color: CL.brandGreen }}>FOX360</div>
    </div>
  ...
  <SlideShell idx={idx}>
    <div style={{ width: '100%', textAlign: 'left', maxWidth: 1100, margin: '0 auto', position: 'relative' }}>
      <div style={{
        ...
        marginBottom: 36,
      }}>FOX360 · MOBILE · MAIO DE 2026</div>
      <h1 style={{
